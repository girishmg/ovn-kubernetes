...
func initSharedGateway(
	...
	if err = initLocalOnlyGateway(nodeName, clusterIPSubnet, subnet); err != nil {
		return err
	}
...
func initLocalOnlyGateway(nodeName string, clusterIPSubnet []string, subnet string) error {
	...
	err = util.LocalGatewayInit(clusterIPSubnet, nodeName, ifaceID, localnetGatewayIP,
		macAddress, localnetGatewayNextHop, subnet, util.LocalNetworkName)
	if err != nil {
