...
func (oc *MasterController) forEachAddressSetUnhashedName(iteratorFn func(
...
func (oc *MasterController) setAddressSet(hashName string, addresses []string) {
...
func (oc *MasterController) createAddressSet(name string, hashName string,
	addresses []string) {
...
func (oc *MasterController) deleteAddressSet(hashName string) {
...
func (oc *MasterController) createPortGroup(name string,
...
func (oc *MasterController) deletePortGroup(hashName string) {
...
func (oc *MasterController) getIPFromOvnAnnotation(ovnAnnotation string) string {
	if ovnAnnotation == "" {
		return ""
	}
